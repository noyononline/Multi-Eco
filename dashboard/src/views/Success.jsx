...
import error from "../assist/error.png";

import success from "../assist/success.png";
import {
...
const Success = () => {
  ...
  useEffect(() => {
    if (activeCode) {
      dispatch(active_stripe_connect_account(activeCode)); // Dispatch action with activeCode
    }
  }, [activeCode, dispatch]);
