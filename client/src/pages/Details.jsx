...
const Details = () => {
  ...
  return (
    <div>
            ...
            <div className="flex py-5 gap-5">
              ...
              <div className="flex flex-col gap-5">
                ...
                <ul className="flex justify-start items-center gap-3">
                  <li>
                    <a
                      href="https://www.facebook.com/akterhossennoyon"
                      className="w-[38px] h-[38px] bg-indigo-500 text-white hover:bg-[#7fad39] hover:text-white flex justify-center items-center rounded-full"
                    >
                      <FaFacebookF />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.facebook.com/akterhossennoyon"
                      className="w-[38px] h-[38px] bg-cyan-500 text-white hover:bg-[#7fad39] hover:text-white flex justify-center items-center rounded-full"
                    >
                      <AiOutlineTwitter />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.facebook.com/akterhossennoyon"
                      className="w-[38px] h-[38px] bg-purple-500 text-white hover:bg-[#7fad39] hover:text-white flex justify-center items-center rounded-full"
                    >
                      <FaLinkedin />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.facebook.com/akterhossennoyon"
                      className="w-[38px] h-[38px] bg-blue-500 text-white hover:bg-[#7fad39] hover:text-white flex justify-center items-center rounded-full"
                    >
                      <AiFillGithub />
                    </a>
                  </li>
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <h2 className="text-2xl font-bold text-slate-600 py-8">
            Related Product
          </h2>
          <div>
            <Swiper
                  ...
                  <Link className="block">
                    ...
                    <div className="p-4 flex flex-col gap-1">
                      ...
                      <div className="flex justify-start items-center gap-3">
                        <h2 className="text-lg text-[#6699ff] font-bold">
                          ${p.price}
                        </h2>
                        <div className="flex">
                          <Ratings ratings={p.rating} />
